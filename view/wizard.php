              ...
              <div class="fv-player-tab fv-player-tab-options" style="display: none">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td class="field" colspan="2">
                      <input type="text" class="text fv_wp_flowplayer_field_logo<?php echo $upload_field_class; ?>" id="fv_wp_flowplayer_field_logo" name="fv_wp_flowplayer_field_splash" value="" placeholder="<?php _e('Default', 'fv_flowplayer'); ?>"/>
