    ...
    <div id="fv-flowplayer-playlist">
        ...
        <tbody>
          ...
          <tr id="fv_wp_flowplayer_add_format_wrapper">
            ...
            <td class="field"><div id="add_rtmp_wrapper"><a href="#" class="partial-underline" onclick="fv_wp_flowplayer_add_rtmp()" style="outline: 0"><span id="add-rtmp">+</span>&nbsp;<?php _e('Add RTMP', 'fv_flowplayer'); ?></a></div></td>  				
          </tr>      
