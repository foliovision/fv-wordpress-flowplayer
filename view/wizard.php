          ...
          <td class="fv-player-shortcode-editor-left">
            <div id="fv-player-shortcode-editor-preview">
              ...
              <div id="fv-player-shortcode-editor-preview-new-tab">
                <a class="button" href="" target="_blank">Playlist too long, click here for preview</a>
              </div>
              ...
              <div class="fv-player-tab fv-player-tab-options" style="display: none">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td class="field" colspan="2">
                      <input type="text" class="text fv_wp_flowplayer_field_logo<?php echo $upload_field_class; ?>" id="fv_wp_flowplayer_field_logo" name="fv_wp_flowplayer_field_splash" value=""/>
                      <label> none: <input type="checkbox" id="fv_wp_flowplayer_field_logo_none" name="fv_wp_flowplayer_field_logo" value="none"/></label>
                      <?php if ($allow_uploads == 'true') { ?>
                        <a id="fv_wp_flowplayer_field_logo_media" class="button add_media" href="#"><span class="wp-media-buttons-icon"></span> <?php _e('Add Image', 'fv_flowplayer'); ?></a>
