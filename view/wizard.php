      ...
      <table>
        <tr>
          ...
          <td class="fv-player-shortcode-editor-right">
            <input type="text" class="hide-if-playlist-active hide-if-singular" name="fv_wp_flowplayer_field_player_name" id="fv_wp_flowplayer_field_player_name" placeholder="Playlist name" /> <span id="player_id_top_text"></span>
