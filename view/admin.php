...
?>
        <table class="form-table2">
          ...
          <?php $fv_fp->_get_checkbox(__('Force landscape orientation in fullscreen on iPhone', 'fv-wordpress-flowplayer'), 'mobile_ios_landscape_fullscreen', __("Always on on Android, now a new experimental feature for iPhone.", 'fv-wordpress-flowplayer')  ); ?>
					<tr>
						<td colspan="4">
							<input type="submit" name="fv-wp-flowplayer-submit" class="button-primary" value="<?php _e('Save All Changes', 'fv-wordpress-flowplayer'); ?>" />
						</td>
