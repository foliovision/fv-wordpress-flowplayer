...
?>
              ...
              <input type="hidden" name="interface[playlist_captions]" value="false" />
					...
					<tr>          
						<td><label for="interface[popup]"><?php _e('HTML popup', 'fv-wordpress-flowplayer'); ?>:</label></td>
						<td>
...
add_meta_box( 'fv_flowplayer_description', __('Description', 'fv-wordpress-flowplayer'), 'fv_flowplayer_admin_description', 'fv_flowplayer_settings', 'normal' );
add_meta_box( 'flowplayer-wrapper', __('Player Skin', 'fv-wordpress-flowplayer'), 'fv_flowplayer_admin_skin', 'fv_flowplayer_settings', 'normal' );
...
add_meta_box( 'fv_flowplayer_amazon_options', __('Amazon S3 Protected Content', 'fv-wordpress-flowplayer'), 'fv_flowplayer_admin_amazon_options', 'fv_flowplayer_settings', 'normal' );
add_meta_box( 'fv_flowplayer_ads', __('Ads', 'fv-wordpress-flowplayer'), 'fv_flowplayer_admin_ads', 'fv_flowplayer_settings', 'normal' );
...
add_meta_box( 'fv_flowplayer_usage', __('Usage', 'fv-wordpress-flowplayer'), 'fv_flowplayer_admin_usage', 'fv_flowplayer_settings', 'normal', 'low' );
