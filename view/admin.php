...
&lt;?php endif; ?&gt;
          ...
          <tr>
						<td><label for="wp_lightbox_video"><?php _e('Handle Wp Lightbox Video shortcodes', 'fv-wordpress-flowplayer'); ?>:</label></td>
						<td>
              <p class="description">
                ...
                <?php _e('Handels the<code>[wp_lightbox_embed_protected_s3_video] [wp_lightbox_protected_s3_video]</code> shortcodes.', 'fv-wordpress-flowplayer'); ?>
