        ...
        <tr<?php echo $amazon_tr_class; ?>>
            ...
            <td>
              <select id="amazon_region[]" name="amazon_region[]">
                ...
                <option value="us-east-1"<?php if( $sRegion == 'us-east-1' ) echo " selected"; ?>><?php _e('US East (N. Virginia)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="us-east-2"<?php if( $sRegion == 'us-east-2' ) echo " selected"; ?>><?php _e('US East (Ohio)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="us-west-1"<?php if( $sRegion == 'us-west-1' ) echo " selected"; ?>><?php _e('US West (N. California)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="us-west-2"<?php if( $sRegion == 'us-west-2' ) echo " selected"; ?>><?php _e('US West (Oregon)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ca-central-1"<?php if( $sRegion == 'ca-central-1' ) echo " selected"; ?>><?php _e('Canada (Central)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ap-south-1"<?php if( $sRegion == 'ap-south-1' ) echo " selected"; ?>><?php _e('Asia Pacific (Mumbai)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ap-northeast-2"<?php if( $sRegion == 'ap-northeast-2' ) echo " selected"; ?>><?php _e('Asia Pacific (Seoul)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ap-southeast-1"<?php if( $sRegion == 'ap-southeast-1' ) echo " selected"; ?>><?php _e('Asia Pacific (Singapore)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ap-southeast-2"<?php if( $sRegion == 'ap-southeast-2' ) echo " selected"; ?>><?php _e('Asia Pacific (Sydney)', 'fv-wordpress-flowplayer'); ?></option>
                <option value="ap-northeast-1"<?php if( $sRegion == 'ap-northeast-1' ) echo " selected"; ?>><?php _e('Asia Pacific (Tokyo)', 'fv-wordpress-flowplayer'); ?></option>                
...
?>
          <style>
            ...
            <?php $fv_fp->_get_checkbox(__('Controlbar Always Visible', 'fv-wordpress-flowplayer'), 'show_controlbar', __('Works for first 2 videos on the page only, to preserve your bandwidth.', 'fv-wordpress-flowplayer') ); ?>
...
?>
        <p><?php _e('Following options are suitable for web developers and programmers.', 'fv-wordpress-flowplayer'); ?></p>
          ...
          <?php $fv_fp->_get_checkbox(__('Enable audio playback', 'fv-wordpress-flowplayer').' (beta)', 'audio', __('Allows audio playback directly in FV Player with all the features.', 'fv-wordpress-flowplayer'), __('Normally there is a fallback to Media Element player.','fv-wordpress-flowplayer' )); ?>
          <?php $fv_fp->_get_checkbox(__('Enable HLS.js', 'fv-wordpress-flowplayer').' (beta)', 'hlsjs', __('Allows HLS playback in all modern browsers.', 'fv-wordpress-flowplayer'), __('HLS normally plays only on iOS, Mac Safari and new Android versions. FV Player increases the compatibility by using Flash engine for HLS. With this option you can go even further and modern browsers supporting MediaSource will play HLS even without Flash. Make sure you setup the required CORS headers.','fv-wordpress-flowplayer' )); ?>
...
<style id="fv-style-preview"></style>
  ...
  fv_flowplayer_admin_skin_get_table( array(
    ...
    'items'                   => array(
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'hasBorder'),
        'default' => 'false',
        'data' => array(
          'fv-preview' => '.flowplayer{border:%val%px solid !important;}'
        )
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'borderColor'),
        'default' => '666666',
        'data'    => array(
          'fv-preview' => '.flowplayer{border-color:#%val% !important;}'
        )
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'marginBottom'),
        'default' => '28',
        'data'    => array(
          'fv-preview' => '.flowplayer { margin: 0 auto %val%px auto !important; display: block !important; }
    .flowplayer.fixed-controls { margin: 0 auto calc(%val%px + 30px) auto !important; display: block !important; }
    ...
    .flowplayer.fixed-controls.has-abloop { margin-bottom: calc(%val%px + 30px) !important; }'
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'bufferColor'),
        'default' => 'EEEEEE',
        'data'    => array(
          'fv-preview' => '.flowplayer .fp-volumeslider, .flowplayer .noUi-background { background-color: #%val% !important; }
                 .flowplayer .fp-buffer, .flowplayer .fv-ab-loop .noUi-handle { background-color: #%val% !important; }'
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'backgroundColor'),
        'default' => 'rgba(0, 0, 0, 0.50)',
        'data'    => array(
          'fv-preview' => '.flowplayer .fv-ab-loop .noUi-handle  { color:#%val% !important; }
                 .fv_player_popup {  background: #%val% !important;}
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'font-face'),
        'default' => 'Tahoma, Geneva, sans-serif',
        'data'    => array(
          'fv-preview' => '#content .flowplayer, .flowplayer { font-family: %val%; }'
        )
      ...
      array(
        'type'           => 'input_hidden',
        'key'            => array('skin-youtuby', 'player-position'),
        'default'        => '',
        'data'           => array(
          'fv-preview' => '.flowplayer { margin-left: 0 !important; }'
        )
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'timeColor'),
        'default' => 'EEEEEE',
        'data'    => array(
          'fv-preview' => '.flowplayer .fp-elapsed, .flowplayer .fp-duration { color: #%val% !important; } 
                 .fv-wp-flowplayer-notice-small { color: #%val% !important; }'
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'durationColor'),
        'default' => 'EEEEEE',
        'data'    => array(
          'fv-preview' => '.flowplayer .fp-controls, .flowplayer .fv-ab-loop, .fv-player-buttons a:active, .fv-player-buttons a { color:#%val% !important; }'
        )
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'design-timeline'),
        'default' => 'fp-full',
        'data'    => array(
          'fv-preview' => ''
        )
      ...
      array(
        'type'    => 'input_hidden',
        'key'     => array('skin-youtuby', 'design-icons'),
        'default' => ' ',
        'data'    => array(
          'fv-preview' => ''
        )
