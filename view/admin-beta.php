...
&lt;?php endif; ?&gt;
          ...
          <?php $fv_fp->_get_checkbox(__('Use XML Video Sitemap', 'fv-wordpress-flowplayer'), 'video_sitemap', sprintf( __('Beta version! Creates <code>%s</code> for Google Webmaster Tools.', 'fv-wordpress-flowplayer'), home_url('video-sitemap.xml') ) ); ?>
