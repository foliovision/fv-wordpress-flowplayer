...
abstract class FV_Player_UnitTestCase extends WP_UnitTestCase {
  ...
  public function fix_newlines( $html ) {
    ...
    $html = preg_replace( "~fv-player-custom-videos-entity-id\[_fv_player_user_video\]\[\d+\]' value='\d+'~", "fv-player-custom-videos-entity-id[_fv_player_user_video][1234]' value='1234'", $html);
