...
final class FV_Player_EndActionsTest extends FV_Player_UnitTestCase {
  ...
  public function testEndActionsPopupHTML() {
    ...
    $found_match = preg_match( '~data-popup="(.*?)"~', $output, $data_popup );
  ...
  public function testEndActionsSplashEnd() {
    ...
    $this->assertTrue( substr_count( $output, ' class="wpfp_custom_background" style="background-image: url(\'https://cdn.site.com/video.jpg\')' ) == 1 );
  }
