...
final class FV_Player_videoPositionSavingTestCase extends FV_Player_Ajax_UnitTestCase {
  ...
  public function testNoSaveForNotLoggedInUsers() {
    ...
    $sample = <<< HTML
<div id="wpfp_31180ef298e0fc79eff36d1114e09913" class="flowplayer no-brand is-splash is-paused skin-slim no-svg fp-slim fp-edgy has-playlist has-playlist-horizontal" data-fv-embed="?fv_player_embed=1" style="max-width: 100%; " data-ratio="0.5625" data-save-position="yes">
...
HTML;
  ...
  public function testSaveAndPlaylistHTMLForLoggedInUsers() {
    ...
    $sample = <<< HTML
<div id="wpfp_245a181e8fd0e4cbe48d6e34cd579eda" class="flowplayer no-brand is-splash is-paused skin-slim no-svg fp-slim fp-edgy has-playlist has-playlist-horizontal" data-fv-embed="?fv_player_embed=1" style="max-width: 100%; " data-ratio="0.5625" data-save-position="yes">
	<div class="fp-ratio" style="padding-top: 56.25%"></div>
	<div class="fp-ui"><noscript>Please enable JavaScript</noscript><div class="fp-play fp-visible"><svg class="fp-play-sharp-fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><style>.fp-color-play{opacity:0.65;}.controlbutton{fill:#fff;}</style></defs><title>play-sharp-fill</title><path class="fp-color-play" d="M49.9217-.078a50,50,0,1,0,50,50A50.0564,50.0564,0,0,0,49.9217-.078Z"/><polygon class="controlbutton" points="73.601 50 37.968 70.573 37.968 29.427 73.601 50" filter="url(#f1)"/></svg></div><div class="fp-preload"><b></b><b></b><b></b><b></b></div></div>
<div class='fvp-share-bar'><ul class="fvp-sharing">
    <li><a class="sharing-facebook" href="https://www.facebook.com/sharer/sharer.php?u=" target="_blank"></a></li>
