    ...
    if( video.type == 'video/youtube' ) {
      ...
      if( typeof fv_flowplayer_conf.youtube_browser_chrome != 'undefined' ) {
        ...
        if( fv_flowplayer_conf.youtube_browser_chrome == 'reduced' ) {
          ...
          // append title & logo
          root.find('.fp-ui').append('<a class="fp-youtube-title" target="_blank" href="' + api.video.src + '">' + video.fv_title_clean + '</div>');
          ...
          if( root.data('youtube-channel-thumbnails') ) {
            var channel_thumbnail_data = root.data('youtube-channel-thumbnails');

            if( typeof channel_thumbnail_data[video.id] != 'undefined' ) {
              var channel_thumbnail = channel_thumbnail_data[video.id];
              root.find('.fp-ui').append('<img class="fp-youtube-channel-thumbnail" src="' + channel_thumbnail + '" />');
            }
