...
jQuery(document).ready( function() {
  ...
  jQuery('.fp-waiting .sq animate').each( function() {
    jQuery(this).attr('values',jQuery(this).attr('values').replace(/0,0,0,.5/g,'255,255,255,.5'));
    jQuery(this).attr('to',jQuery(this).attr('to').replace(/0,0,0,.5/g,'255,255,255,.5'))
  });
...
flowplayer( function(api,root) {
  ...
  if( root.data('button-no-picture') ) {
    ...
    button_no_picture.insertAfter( root.find('.fp-controls .fp-volume') ).click( function(e) {
      ...
      jQuery(this).toggleClass('is-active fp-color');
    });    
  }
  
  if( root.data('button-repeat') ) {
    if( api.conf.playlist.length > 0 ) {
      var playlist_button = jQuery('<strong class="fv-fp-playlist mode-normal"><svg viewBox="0 0 80.333 80" width="20px" height="20px" class="fvp-icon fvp-replay-list"><use xlink:href="#fvp-replay-list"></use></svg><svg viewBox="0 0 80.333 71" width="20px" height="20px" class="fvp-icon fvp-shuffle"><use xlink:href="#fvp-shuffle"></use></svg><svg viewBox="0 0 80.333 71" width="20px" height="20px" class="fvp-icon fvp-replay-track"><use xlink:href="#fvp-replay-track"></use></svg><svg viewBox="0 0 80.333 80" width="20px" height="20px" class="fvp-icon fvp-playlist-play"><use xlink:href="#fvp-playlist-play"></use></svg></strong>'),
          playlist_menu = jQuery('<div class="fp-menu fv-fp-playlist-menu"><a data-action="repeat_playlist"><svg viewBox="0 0 80.333 80" width="20px" height="20px" class="fvp-icon fvp-replay-list"><use xlink:href="#fvp-replay-list"></use></svg> <span class="screen-reader-text">Repeat Playlist</span></a><a data-action="shuffle_playlist"><svg viewBox="0 0 80.333 71" width="20px" height="20px" class="fvp-icon fvp-shuffle"><use xlink:href="#fvp-shuffle"></use></svg> <span class="screen-reader-text">Shuffle Playlist</span></a><a data-action="repeat_track"><svg viewBox="0 0 80.333 71" width="20px" height="20px" class="fvp-icon fvp-replay-track"><use xlink:href="#fvp-replay-track"></use></svg> <span class="screen-reader-text">Repeat Track</span></a><a class="fp-selected" data-action="normal"><svg viewBox="0 0 80.333 80" width="20px" height="20px" class="fvp-icon fvp-playlist-play"><use xlink:href="#fvp-playlist-play"></use></svg> <span class="screen-reader-text">Normal</span></a></div>').insertAfter( root.find('.fp-controls') );
      ...
      playlist_button.insertAfter( root.find('.fp-controls .fp-volume') ).click( function(e) {
        e.preventDefault();
        e.stopPropagation();
        if( playlist_menu.hasClass('fp-active') ) api.hideMenu(playlist_menu[0]);
        else api.showMenu(playlist_menu[0]);
      });
      ...
      button_track_repeat.insertAfter( root.find('.fp-controls .fp-volume') ).click( function(e) {
        ...
        if( api.video.loop ) {
          ...
          jQuery(this).removeClass('is-active fp-color');
        } else {
          api.video.loop = true;
          jQuery(this).addClass('is-active fp-color');
        }
      });
