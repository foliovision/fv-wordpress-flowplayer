...
flowplayer(function(api, root) {
  ...
  function check_size() {
    ...
    var el = player;
    if( !root.hasClass('fp-is-embed') && ( root.parent().hasClass('fp-playlist-vertical-wrapper') || root.parent().hasClass('fp-playlist-text-wrapper') ) ) el = root.parent(); // in some cases we apply the wrapper
