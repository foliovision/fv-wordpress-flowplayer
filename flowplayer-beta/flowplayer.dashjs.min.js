                                ...
                                Object.keys(EVENTS).forEach(function (key) {
                                    ...
                                    bean.on(videoTag, type, function (e) {
                                        ...
                                        case "error":
                                            ...
                                            break;                                        
                                        case "waiting":
                                            if( videoTag.currentTime > 0.9995 * videoTag.duration ) { // if you get this event at the end of video, it means Dash JS has stalled, probably because of shorter last segment duration. The video should end. By using this code we loose the ability to seek to last 4 seconds of video if it's 2 hours long
