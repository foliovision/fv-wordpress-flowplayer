...
$fv_wp_flowplayer_ver = '7.4.999.727.3';
...
require_once(dirname( __FILE__ ) . '/models/db-player.php');
require_once(dirname( __FILE__ ) . '/models/db-video.php');
require_once(dirname( __FILE__ ) . '/models/db-video-meta.php');
