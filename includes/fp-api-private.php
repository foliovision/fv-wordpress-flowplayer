...
<script type="text/javascript">
  ...
  function auto_updates(){
   ...
   public function CheckPluginUpdate( $checked_data ){
      $plugin_path = ( isset($this->strPluginFile) ) ? $this->strPluginFile : $this->strPluginSlug.'/'.$this->strPluginSlug.'.php';
      ...
      $raw_response = false;///get_transient( $this->strPluginSlug.'_fp-private-updates-api' );
      if( !$raw_response ){
   ...
   public function PluginAPICall( $def, $action, $args ){					
      ...
      $plugin_info = get_site_transient( 'update_plugins' );
			$plugin_path = ( isset($this->strPluginFile) ) ? $this->strPluginFile : $this->strPluginSlug.'/'.$this->strPluginSlug.'.php';
      $current_version = ( isset($plugin_info->response[$plugin_path]) ) ? $plugin_info->response[$plugin_path] : false;
