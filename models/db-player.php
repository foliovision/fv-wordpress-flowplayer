...
CREATE TABLE `" . self::$db_table_name . "` (
  ...
  `align` varchar(7) NOT NULL DEFAULT 'Default',
  `author` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `autoplay` varchar(7) NOT NULL DEFAULT 'Default',
  `controlbar` varchar(7) NOT NULL DEFAULT 'Default',
  `copy_text` varchar(120) NOT NULL,
  `changed_by` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `date_created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `date_modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `embed` varchar(12) NOT NULL DEFAULT 'Default',
  `end_actions` varchar(10) NOT NULL,
  `end_action_value` varchar(255) NOT NULL DEFAULT '',
