...
CREATE TABLE `" . self::$db_table_name . "` (
  ...
  `videos` varchar(65535) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `align` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  `author` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `autoplay` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  `controlbar` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  ...
  `embed` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  `end_actions` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `end_action_value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `playlist` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  `playlist_advance` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qsel` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `share` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  ...
  `sticky` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
