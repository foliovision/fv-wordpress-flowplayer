...
// class handling events tracing via OpenTracing API (Zipkin-specific implementation)
class FV_Player_Debug_Tracing {

  public function __construct() {
    add_action( 'wp_ajax_fv_player_debug_trace', array($this, 'debug_trace') );
  }
