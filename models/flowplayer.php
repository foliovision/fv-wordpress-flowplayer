...
class flowplayer extends FV_Wordpress_Flowplayer_Plugin {
  ...
  function css_generate( $style_tag = true ) {
    ...
    #content .flowplayer .fp-embed-code textarea, .flowplayer .fp-embed-code textarea { line-height: 1.4; white-space: pre-wrap; color: <?php echo trim($this->conf['durationColor']); ?> !important; height: 40px; font-size: 10px; }
