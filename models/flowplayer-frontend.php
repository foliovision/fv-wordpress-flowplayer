...
//var_dump($sHTML);die();
  ...
  function get_sharing_html() {
    ...
    if( $this->aCurArgs['embed'] == 'false' || ( $this->conf['disableembedding'] == 'true' && $this->aCurArgs['embed'] != 'true' ) || preg_match( "~vimeo.com/(?:video/|moogaloop\.swf\?clip_id=)?(\d+)~i", $this->aCurArgs['src'] ) && $this->conf['integrations']['embed_iframe'] === 'false' ) {
      $sHTMLEmbed = '';
    }
