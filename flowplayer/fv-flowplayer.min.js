...
jQuery(document).on('focus','input[type=text]', function() { var api = jQuery(this).parents('.flowplayer').data('flowplayer'); if( api ) api.disable(true) });
jQuery(document).on('blur','input[type=text]', function() { var api = jQuery(this).parents('.flowplayer').data('flowplayer'); if( api ) api.disable(false) });
