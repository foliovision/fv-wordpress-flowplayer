...
if( typeof(flowplayer) != "undefined" ) {
  flowplayer(function (api) {
    api.bind("load", function (e, api, video) {
      var sURL = encodeURIComponent(document.URL);
      var bEmbed = (jQuery(e.currentTarget).attr('data-fvembed')=="false") ? false : true;
      var sEmbedLink = '';
      if( bEmbed ){
        jQuery(e.currentTarget).find('.fp-embed-code').wrapInner('<div class="real-embed-code" style="display: none"></div>');
        sEmbedLink = ' <label>Or get the <a href="#" class="real-embed-code-trigger">embed code</a></label>';
      } else {
        jQuery(e.currentTarget).find('.fp-embed-code').html('');
      }
      jQuery(e.currentTarget).find('.fp-embed-code').prepend('<label>Share the video</label><ul class="fvp-sharing"><li><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+sURL+'" class="sharing-facebook">Facebook</a></li> <li><a target="_blank" href="https://twitter.com/home?status='+sURL+'" class="sharing-twitter">Twitter</a></li> <li><a target="_blank" href="https://plus.google.com/share?url='+sURL+'" class="sharing-google">Google+</a></li> <li><a target="_blank" href="mailto:?body='+encodeURIComponent('Check the amazing video here: ')+sURL+'" class="sharing-email">Email</a></li></ul>'+sEmbedLink);
      if( bEmbed ){
        jQuery(e.currentTarget).find('.real-embed-code textarea').off('click');
        jQuery(e.currentTarget).find('.real-embed-code-trigger').click( function() {
          jQuery(this).parent().siblings('.real-embed-code').toggle();
