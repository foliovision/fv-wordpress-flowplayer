...
flowplayer(function(api, root) {
  ...
  if( root.data('fsforce') == true || playlist.hasClass('fp-playlist-season') ) {
    var position = -1, unload = root.find('.fp-unload');
    ...
    api.fakeFullscreen = function( flag = -1 ) {
      if( position == -1 ) position = root.css('position');
      
      if( flag == -1 ) flag = !api.isFakeFullscreen;
