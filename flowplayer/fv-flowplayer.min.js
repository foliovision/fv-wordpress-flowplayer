 ...
 *  Player notices
 */
function fv_player_notice(root, message, timeout, class_name) {
  if( class_name ) {
    class_name = 'fvfp-notice-'+class_name;
    jQuery('.'+class_name).remove();
  }
  
  var notice = jQuery('<div class="fvfp-notice '+class_name+'"><div class="fvfp-notice-content">'+message+'</div></div>');
