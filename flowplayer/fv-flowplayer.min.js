...
flowplayer( function(api,root) {
  ...
  function fv_track(e,api,data) {
    if (typeof _gat != 'undefined') {
      ...
      tracker._trackEvent( "Video "+fv_ga_events[i], api.engine + "/" + video.type, decodeURIComponent(name), 1 );
    }
