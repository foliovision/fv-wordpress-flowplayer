...
if( typeof(fv_flowplayer_admin_test_media_array) != "undefined" ) {
	...
	jQuery(document).ready( function() {
		fv_flowplayer_scroll_video_checker = true;
	} );
	...
	setInterval( function() {
		if( !fv_flowplayer_scroll_video_checker ) {
			return;
		}
		...
		jQuery('.flowplayer').each( function() {
			...
			if( iPlayer > iMin && iPlayer < iMax ) {
				if( typeof(jQuery(this).flowplayer().fv_flowplayer_scroll_video_checker) == "undefined" ) {				
					jQuery(this).flowplayer().fv_flowplayer_scroll_video_checker = true;
...
function fv_flowplayer_admin_test_media( hash, media ) {
    ...
    jQuery('#wpfp_notice_'+hash).show();
        ...
        for( var i in obj ) {
          ...
          var sCheckerDetails = fv_flowplayer_admin_message_parse_group(obj[i].details);
