...
flowplayer( function(api,root) {
  ...
  api.bind('ready', function(e,api) {
    ...
    if( root.data('button-rewind') && root.find('.fv-fp-rewind').length == 0 ) {
      var button_rewind = jQuery('<span class="fv-fp-rewind"><svg viewBox="0 0 24 24" width="24px" height="24px" class="fvp-icon fvp-rewind"><use xlink:href="#fvp-rewind"></use></svg></strspanong>');
