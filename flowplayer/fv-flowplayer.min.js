 ...
 */
flowplayer.sendVideoPositions = function(async, callback) {
    if (async !== true) {
        async = false;
    }
...
flowplayer( function(api,root) {
    ...
    if (typeof(flowplayer.conf.video_position_save_enable) != 'undefined') {
        // variables
        var
            ...
            storeVideoPosition = function (e, api) {
                if (api.video.sources) {
                    ...
                    if (progressEventsCount++ >= sendPositionsEvery) {
                        ...
                        // send the call home
                        ajaxCall = flowplayer.sendVideoPositions(true, function () {
                            ajaxCall = null;
                        });
