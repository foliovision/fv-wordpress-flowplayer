...
jQuery(window).on('resize',function(){
  var root = jQuery('iframe[src][height][width]'); 
  if( root.attr('id') && root.attr('id').match(/fv_vimeo_/) && root.width() <= root.attr('width') )
  root.height( root.width() * root.attr('height') / root.attr('width') );
}).trigger('resize');
