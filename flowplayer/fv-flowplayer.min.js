...
flowplayer(function(api, root) {  //  when using Gravity Forms Partial Submissions the whole player is cloned if it's placed in the form, causing it to play again in the background
