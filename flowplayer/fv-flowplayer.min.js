   ...
   var engine = {
      ...
      load: function(video) {
         ...
         var html5Tag = common.findDirect('video', root)[0] || common.find('.fp-player > video', root)[0],            
            url = ( typeof(player.fv_video_loaded) != "undefined" || player.video.index > 0 ) ? video.src : escapeURL(video.src), //  todo: fix properly: https://github.com/flowplayer/flowplayer/issues/817
            is_absolute = /^https?:/.test(url);
            
         player.fv_video_loaded = true;
