...
if( typeof(flowplayer) != "undefined" ) {
  flowplayer(function (api) {
    api.bind("load", function (e, api, video) {
      ...
      jQuery(e.currentTarget).find('.fp-embed-code').html('<label>Share the video</label><ul class="fvp-sharing"><li><a href="https://www.facebook.com/sharer/sharer.php?u='+sURL+'" class="sharing-facebook">Facebook</a></li> <li><a href="https://twitter.com/home?status='+sURL+'" class="sharing-twitter">Twitter</a></li> <li><a href="https://plus.google.com/share?url='+sURL+'" class="sharing-google">Google+</a></li> <li><a href="mailto:?body='+encodeURIComponent('Check the amazing video here: ')+sURL+'" class="sharing-email">Email</a></li></ul>');
