...
flowplayer(function (api) {
  api.bind("ready", function (e, api) {
    if( typeof(fv_flowplayer_ad) != "undefined" && typeof(fv_flowplayer_ad[jQuery(e.currentTarget).attr('id')]) != "undefined" && jQuery(e.currentTarget).width() >= parseInt(fv_flowplayer_ad[jQuery(e.currentTarget).attr('id')].width) ) {
