...
function fv_flowplayer_mobile_switch(id) {
	...
	if(
		(
			...
			(jQuery(window).width()<=320 || jQuery(window).height()<=480) //  todo: improve for Android with 1.5 pixel ratio 
		)
		&&
...
flowplayer( function(api,root) {
  ...
  function fv_track(e,api,data) {
    if (typeof _gat != 'undefined') {
      ...
      if( /fv_ga_debug/.test(window.location.href) ) console.log('FV GA: '+e.type+' - '+ "Video "+fv_ga_events[i]+" " + api.engine.engineName + "/" + video.type + " '" + name + "'")
...
flowplayer( function(api,root) {
  ...
  api.bind('ready', function(e,api) {
    ...
    if( /android/.test(navigator.userAgent.toLowerCase()) || typeof(api) == "undefined" || api.engine.engineName == "flash" || api.engine.engineName == 'fvyoutube' || !flowplayer.support.inlineVideo ) {
