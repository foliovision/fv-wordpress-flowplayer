...
flowplayer(function (api,root) {
  ...
  if( root.data('end_popup_preview') ){
    api.bind('progress', function(e,api) {console.log('finish trigger!');
      api.pause();
  ...
  }).bind("finish", function (e, api) {console.log('finish catch 1!');
    if( typeof(api.video.index) == "undefined" || api.video.index+1 == api.conf.playlist.length ) {console.log('finish catch 2!');
      if( root.find('.wpfp_custom_popup').length > 0) {console.log('finish catch 3!');
        root.find('.wpfp_custom_popup').show();
      } else if( typeof(fv_flowplayer_popup) != "undefined" && typeof(fv_flowplayer_popup[player_id]) != "undefined" ) {console.log('finish catch 4!');
