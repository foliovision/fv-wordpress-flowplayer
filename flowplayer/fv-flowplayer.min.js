...
flowplayer( function(api,root) {
  ...
  api.bind('ready', function(e,api) {  
    ...
    if(api.video.type != 'application/x-mpegurl'){
      return;
    }

    initAudio(hlsjs);

    if (!hlsjs || !audioUXGroup || audioUXGroup.length < 2) {
      return;
    }
    ...
    //  hls_audio_menu.append(common.createElement("a", {"data-audio": audioTrack.name}, audioTrack.name));
