...
( function($) {
  ...
  flowplayer( function(api,root) {
    root = jQuery(root);
    var button = jQuery('<input type="button-splash" value="Screenshot" class="button" id="fv-splash-screen-button" />'),
    ...
    api.bind('ready', function(e,api) {
      ...
      button.click(function(){
        try {
          ...
          console.log(fv_player_editor_conf.splashscreen_nonce);
        }
        catch(err) {
          alert('This video cannot be screenshotted');
          return;
        }

        jQuery.post(fv_fp_ajaxurl, data, function(response) {
          if(response.src){
            jQuery('#fv_wp_flowplayer_field_splash').val(response.src);  
          }
          if(response.error){
  ...
  jQuery(document).on('fv_flowplayer_player_editor_reset fvp-preview-complete', function() {
