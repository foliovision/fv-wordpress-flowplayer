...
function fv_flowplayer_admin_test_media( hash, media ) {
    ...
    jQuery('#wpfp_notice_'+hash).show();
        ...
        for( var i in obj ) {
          ...
          if( typeof(obj[i].warnings) != "undefined" && Object.keys(obj[i].warnings).length > 0 ) {
...
if( typeof(flowplayer) != "undefined" ) {
  flowplayer(function (api) {
    api.bind("load", function (e, api, video) {
      ...
      jQuery(e.currentTarget).find('.fp-embed-code').html('<label>Share the video</label><ul class="fvp-sharing"><li><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u='+sURL+'" class="sharing-facebook">Facebook</a></li> <li><a target="_blank" href="https://twitter.com/home?status='+sURL+'" class="sharing-twitter">Twitter</a></li> <li><a target="_blank" href="https://plus.google.com/share?url='+sURL+'" class="sharing-google">Google+</a></li> <li><a target="_blank" href="mailto:?body='+encodeURIComponent('Check the amazing video here: ')+sURL+'" class="sharing-email">Email</a></li></ul>');
      //<label><a class="fvp-embed-code-trigger" href="#">Embed</a></label>
      /*jQuery('.fvp-embed-code',e.currentTarget).append(sEmbed);
      jQuery('.fvp-embed-code-trigger',e.currentTarget).click( function() { jQuery(this).parent().siblings('.fvp-embed-code').toggle(); return false });*/
    });
  });
}
