...
flowplayer(function(player, root) {
  ...
  player.embedCode = function() {    
    ...
    var embed = data.match(/fvp-[0-9]*/);

    embed ='/' + embed + '#' + fv_get_current_hash(player);
    data = data.replace(/\/fvp-[0-9]*\//, embed);
  ...
  flowplayer(function (api, root) {
    if( jQuery(root).find('.sharing-link').length > 0 ) {
      api.on('progress',function(e,api){
        ...
        var hash = fv_get_current_hash(api);
...
function fv_get_current_hash(api) {
