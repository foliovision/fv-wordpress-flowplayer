...
if( typeof(fv_flowplayer_admin_js_test) != "undefined" && fv_flowplayer_admin_js_test ) {
	jQuery.post( fv_fp_ajaxurl, { action: 'fv_wp_flowplayer_js_alive' }, function( response ) { } );
}
...
jQuery(".flowplayer:first").bind('boot', function() { 
