...
jQuery(document).ready( function() {
  ...
  flowplayer( function(api,root) {
    ...
    if( playlist.length ){            
      playlist.height(vertical_playlist_height());  
      jQuery(window).resize(function(){
        playlist.height(vertical_playlist_height());
      })
    }
...
flowplayer( function(api,root) {
  ...
  api.bind('error',function(){
    if( typeof(fv_flowplayer_user_edit) === 'undefined' && jQuery('.fp-message>p',root).html().match('(https?:)?//') ){
      jQuery('.fp-message>p',root).html('');
    }
  });
...
jQuery(document).on('focus','.wpfp_custom_popup_content input[type=text], .wpfp_custom_popup_content textarea', function() {
  var api = jQuery(this).parents('.flowplayer').data('flowplayer');
  if( api ) api.disable(true);
});
jQuery(document).on('blur','.wpfp_custom_popup_content input[type=text], .wpfp_custom_popup_content textarea', function() {
  var api = jQuery(this).parents('.flowplayer').data('flowplayer');
...
jQuery(document).ready(function(){
  ...
  if(fv_flowplayer_conf.lightbox_images ) {
    jQuery(".colorbox").filter(function() {
        return this.href.match(/\.(png|jpg|jpeg|gif)/);
    }).fv_player_pro_colorbox( {
