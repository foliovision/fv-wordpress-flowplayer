...
flowplayer(function (api) {
  api.bind("ready", function (e, api) {
    if( typeof(fv_flowplayer_ad[jQuery(e.currentTarget).attr('id')]) != "undefined" && jQuery(e.currentTarget).width() >= parseInt(fv_flowplayer_ad[jQuery(e.currentTarget).attr('id')].width) ) {
      jQuery(e.currentTarget).append( '<div id="'+jQuery(e.currentTarget).attr('id')+'_ad" class="wpfp_custom_ad">'+fv_flowplayer_ad[jQuery(e.currentTarget).attr('id')].html+'</div>' );
    }
  }).bind("finish", function (e, api) {
    if( typeof(fv_flowplayer_popup[jQuery(e.currentTarget).attr('id')]) != "undefined" ) {
