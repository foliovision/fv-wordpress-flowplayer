...
flowplayer( function(api,root) {
  ...
  api.bind('ready', function(e,api) {
    ...
    if( root.data('button-rewind') && root.find('.fv-fp-rewind').length == 0 ) {
      var button_rewind = jQuery('<span class="fv-fp-rewind"><svg viewBox="0 0 240 240" width="20px" height="20px" class="fvp-icon fvp-rewind"><use xlink:href="#fvp-rewind"></use></svg></strspanong>');
