...
flowplayer(function(api, root) {
  ...
  if (globalSticky || sticky) {
    if (flowplayer.support.firstframe) {
      ...
      fv_player_sticky_video($root, api, $playerDiv, stickyPlace, stickyWidth, stickyHeight);
    } else {
     return;
    }
  }
...
function fv_player_sticky_video($root, api, $playerDiv, stickyPlace, stickyWidth, stickyHeight) {
  var change = false;
  ...
  api.on('unload', function() {
    change = false;
    fv_player_sticky_class_remove($playerDiv, stickyPlace);
  });
  $window
    .on("resize", function() {
      top = $flowplayerDiv.offset().top;
    ...
    .on("scroll", function() {
      if ($window.scrollTop() > offset && change) {
        fv_player_sticky_class_add($playerDiv, stickyPlace, stickyWidth, stickyHeight);
      } else {
        fv_player_sticky_class_remove($playerDiv, stickyPlace);
      }
    });
...
function fv_player_sticky_class_add($playerDiv, stickyPlace, stickyWidth, stickyHeight) {
  jQuery($playerDiv).addClass("is-sticky-" + stickyPlace);
  jQuery($playerDiv).css("width", stickyWidth);
  jQuery($playerDiv).css("height", stickyHeight);
  jQuery($playerDiv).css("max-height", stickyHeight);
}

function fv_player_sticky_class_remove($playerDiv, stickyPlace) {
  jQuery($playerDiv).removeClass("is-sticky-" + stickyPlace);
  jQuery($playerDiv).css("width", "");
  jQuery($playerDiv).css("height", "");
  jQuery($playerDiv).css("max-height", "");
}