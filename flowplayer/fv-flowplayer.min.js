...
flowplayer(function (api,root) {
  ...
  function show_ad() {
    if( (!ad || ad.length == 0) && !root.hasClass('is-cva') && typeof(fv_flowplayer_ad) != "undefined" && typeof(fv_flowplayer_ad[player_id]) != "undefined" && root.width() >= parseInt(fv_flowplayer_ad[player_id].width) ) {
