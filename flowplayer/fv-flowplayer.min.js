...
console.log('FV Player: Time to load: '+performance.now());
...
//jQuery(document).ready( function() {
  ...
  var loading = setInterval( function() {
    ...
    if( loading_count < 1000 && (
      ...
      if( window.fv_video_intelligence_conf && !window.FV_Player_IMA ) console.log('FV Player: Loading waiting for VAST' );
      if( window.fv_vast_conf && !window.FV_Player_IMA ) console.log('FV Player: Loading waiting for vi' );
      if( window.fv_player_pro && !window.FV_Flowplayer_Pro && document.getElementById('fv_player_pro') != fv_player_pro ) console.log('FV Player: Loading waiting for Pro' );
      return;
    }
...
jQuery(document).ready( function() {
  console.log('FV Player: Previously I would load at: '+performance.now());
});

function fv_player_preload() {console.log('FV Player: Loading at: '+performance.now());
