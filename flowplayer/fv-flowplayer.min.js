...
jQuery(document).ready( function() {
  ...
  flowplayer( function(api,root) {
    ...
    api.bind('load', function(e,api,video) {
      ...
      var is_playlist = jQuery('[rel='+root.attr('id')+']').find('.is-active').length;  //  exp: ugly way of detecign if the playback was initiated via playlist clik
      if( is_playlist && ! isElementInViewport(root[0])) {
        jQuery('html, body').animate({
          scrollTop: jQuery(root).offset().top - 100
        }, 300);
        //  todo: this could use some notice about the video being loaded                  
      }
    } );
