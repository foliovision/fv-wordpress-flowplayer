...
jQuery(document).ready(function(){
  ...
  if( flowplayer.conf.lightbox_images ) {
    jQuery(".colorbox").not('[href^="#"]').fv_player_pro_colorbox( {
  ...
  jQuery("[id ^=fv_flowplayer_][id $=_lightbox]").fv_player_pro_colorbox(
    {
      /*className: 'fv_player_pro_lightbox',*/
      rel: 'group1',
      current: "{current} of {total}",
  ...
  jQuery(document).bind('fv_player_pro_box_complete', function(e){
    ...
    if( fv_player_lightbox_fresh && jQuery('#fv_player_pro_boxLoadedContent').find('.flowplayer').data("flowplayer") && !flowplayer.support.touch ) {
      ...
      api.load();
    } else if( fv_player_lightbox_fresh && flowplayer.conf.playlist[jQuery('#fv_player_pro_boxLoadedContent').find('.flowplayer').attr('id')] ) { //  todo: check
     // TODO: check
      flowplayer.load(jQuery('#fv_player_pro_boxLoadedContent').find('.flowplayer'));
    }
