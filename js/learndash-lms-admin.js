jQuery( function($) {
  ...
  var lms_show_fields = jQuery('#learndash-lesson-display-content-settings_lesson_fv_player_field');
  ...
  var video_progression_toggle = jQuery( '#learndash-lesson-display-content-settings_lesson_video_enabled' );
