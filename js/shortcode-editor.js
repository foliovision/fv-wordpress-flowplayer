  ...
  window.fv_player_editor = (function($) {
    ...
    */
    ...
    function editor_init() {
      ...
      jQuery('input[name="fv_wp_flowplayer_field_duration"], input[name="fv_wp_flowplayer_field_auto_splash"], input[name="fv_wp_flowplayer_field_auto_caption"]').remove();
...
jQuery(document).on('click','.fv_player_splash_list_preview', function() {
  ...
  jQuery(this).parents('tr').find('.fv-player-edit').trigger('click');
});
